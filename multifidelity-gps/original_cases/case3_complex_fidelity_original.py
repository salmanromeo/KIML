...
def standard_gp_co_kriging(N_HF, N_LF, plot_results=True):
    ...
    if plot_results:
        ...
        ax1.set_title(f'Case 3: Complex Fidelity | Standard GP | $N_{{HF}}$={N_HF} | RMSE: {rmse:.4f} | Complexity: {complexity}', 
                      fontsize=11, pad=10)
...
def joint_gp_co_kriging(N_HF, N_LF, plot_results=True):
    ...
    if plot_results:
        ...
        ax1.legend(loc='best', mode="expand", ncol=2, fontsize=9)
        ax1.text(0.02, 0.99, 'a', transform=ax1.transAxes, fontsize=14, fontweight='bold', va='top')
        ax1.set_title(f'Case 3: Complex Fidelity | Joint GP | $N_{{HF}}$={N_HF} | RMSE: {rmse:.4f} | Complexity: {complexity}', 
                      fontsize=11, pad=10)
...
#%%    
    ...
    ax.set_title('Case 3: Complex Fidelity | GP Methods Comparison: RMSE vs Data Quantity', fontsize=13, pad=15)
